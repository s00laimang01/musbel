    ...
    >
      ...
      >
        <p style={{ margin: "0", color: "#854d0e" }}>
          We've detected that you're using an older browser. We're showing you a
          simplified version of our site for better compatibility.
        </p>
      </div>
      ...
      <main>
        ...
        <section style={{ marginBottom: "30px" }}>
          <h2
            style={{ color: "#0f172a", fontSize: "20px", marginBottom: "15px" }}
          >
            Welcome to {configs.appName}
          </h2>
          <p style={{ color: "#334155", marginBottom: "15px" }}>
            Nigeria's most reliable platform for affordable data bundles,
            instant airtime recharge, seamless bill payments, and exam result
            token purchases.
          </p>
          <a
            href="/auth/sign-up"
        ...
        <section style={{ marginBottom: "30px" }}>
          ...
          <ul style={{ padding: "0 0 0 20px", color: "#334155" }}>
            <li style={{ marginBottom: "10px" }}>
              Data Bundles - Best prices on MTN, Airtel, Glo, and 9mobile
            </li>
            <li style={{ marginBottom: "10px" }}>
              Airtime Recharge - Instant delivery to any network
            </li>
            <li style={{ marginBottom: "10px" }}>
              Bill Payments - Electricity, Cable TV, and more
            </li>
            <li style={{ marginBottom: "10px" }}>
              Exam Result Tokens - WAEC, NECO, and JAMB
            </li>
          </ul>
        </section>
      </main>
